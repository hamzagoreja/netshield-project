        ...
        try {
            ...
            for (int attempt = 1; attempt <= 5; attempt++) {
                ...
                if (status.equals("completed")) {
                    ...
                    // ✅ Fix 1: derive verdict from actual scan results
                    String verdict;
                    String riskLevel;
                    ...
                    if (malicious > 0) {
                        verdict        = "MALICIOUS";
                        riskLevel      = "HIGH RISK";
                        recommendation = "This URL is dangerous. Do not visit it.";
                    } else if (suspicious > 0) {
                        verdict        = "WARNING";
                        riskLevel      = "MEDIUM RISK";
                        recommendation = "This URL looks suspicious. Open with caution.";
                    } else {
                        verdict        = "SAFE";
                        riskLevel      = "LOW RISK";
                    ...
                    // ✅ Fix 2: security score based on actual results
                    int securityScore = 0;
                    if (totalEngines > 0) {
