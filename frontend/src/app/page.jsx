...
export default function HomePage() {
  ...
  const navItems = [
    { href: "/scans/url",   icon: "🔗", label: "URL SCAN",   desc: "Analyse links" },
    { href: "/scans/file",  icon: "📄", label: "FILE SCAN",  desc: "Check documents" },
    { href: "/scans/image", icon: "🖼️", label: "IMAGE SCAN", desc: "Inspect images" },
    { href: "/history",     icon: "📋", label: "HISTORY",    desc: "Past results" },
  ];
